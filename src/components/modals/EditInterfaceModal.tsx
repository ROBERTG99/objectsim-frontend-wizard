...
interface EditInterfaceModalProps {
  ...
  interface_: {
    ...
    name: string;
    namespace: string;
    methodSignatures?: MethodSignatureFormData[];
  } | null;
  ...
  useEffect(() => {
    if (interface_ && open) {
      form.reset({
        ...
        namespace: interface_.namespace,
        methodSignatures: interface_.methodSignatures || [],
      });
    }
  }, [interface_, open, form]);
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Editar interfaz</DialogTitle>
        </DialogHeader>
